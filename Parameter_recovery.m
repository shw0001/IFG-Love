        ...
        Update_param=strcat('D:\VBA_toolbox_master\Results\test_scaling_asymmetry');%',m,'
    ...
    stimulation_data=cell2mat(stimulation_data);
     ...
     fname2=strcat('D:\VBA_toolbox_master\Results\test_stimulation_data.mat');
     fname3=strcat('D:\VBA_toolbox_master\Results\New_scaling_asymmetry.mat');
